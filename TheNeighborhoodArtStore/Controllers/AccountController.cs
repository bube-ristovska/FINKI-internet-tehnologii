...
namespace TheNeighborhoodArtStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    var nov_model = new AddToRoleModel();
                    nov_model.Email = model.Email;

                    return RedirectToAction("AddToRole", "Account", nov_model);
                }
                AddErrors(result);
            }
        ...
        public ActionResult AddUserToRole(AddToRoleModel model)
        {
            ...
            {
                return HttpNotFound(); //404 може и до custom 404 да биде
            }
            TempData["email"] = model.Email;
            if (model.SelectedRole == "Artist")
            {   
